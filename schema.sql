...
insert menu(role,label,icone,route) values ("admin","Liste des DA-BC-FC","fas fa-fw fa-list","/lec-da");
...
insert into etat(id_etat,value,def) values (1,1,"créer"),(1,2,"validé"),(3,3,"refusé");
insert into etat(id_etat,value,def) values (4,4,"Partiellement");
